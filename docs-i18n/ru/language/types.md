...
title: Тип данных
section: language
sectionTitle: Язык языка
order: 10
searchKeywords: ["типы","тип данных","вводить","плавать","струна","булевый","список","массив","астере","целое число","реальное число","последовательность"]
---
# Kiểu dữ liệu
