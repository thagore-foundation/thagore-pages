---
title: Tour ngôn ngữ
titleEn: Language Tour
section: getting-started
sectionTitle: Bắt đầu
sectionTitleEn: Getting Started
order: 3
searchKeywords: ["tour", "language tour", "basics", "cơ bản", "biến", "variables", "functions", "hàm", "loops", "vòng lặp", "conditions", "điều kiện"]
---
